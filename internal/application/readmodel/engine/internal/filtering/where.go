...
func buildWhereItemShape(
	...
	for _, fieldName := range ordered.MapKeys(entityType.MetaFields) {
	...
	for _, refFieldName := range ordered.MapKeys(entityType.RefFields) {
	...
	for _, sectionName := range ordered.MapKeys(entityType.Sections) {
