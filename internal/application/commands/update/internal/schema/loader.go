...
import (
	...
	schemaentity "github.com/anatoly-tenenev/spec-cli/internal/application/commands/update/internal/schema/internal/entity"
...
func Load(path string, sourcePath string) (model.Schema, *domainerrors.AppError) {
	...
	if err != nil {
		return model.Schema{}, newSchemaError(
	...
	spec := model.Schema{EntityTypes: make(map[string]model.EntityTypeSpec, len(entityRaw))}
